using AkadaemiaAnyder.Modules.Artisan.CraftingLogic.CraftData;
...
using static AkadaemiaAnyder.Modules.Artisan.RawInformation.AddonExtensions;

namespace AkadaemiaAnyder.Modules.Artisan.CraftingLogic.Solvers;
