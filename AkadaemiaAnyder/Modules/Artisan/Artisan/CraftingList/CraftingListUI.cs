...
using AkadaemiaAnyder.Modules.Artisan.GameInterop;
...
using AkadaemiaAnyder.Modules.Artisan.UI;
...
namespace AkadaemiaAnyder.Modules.Artisan.CraftingLists
{
    internal class CraftingListUI
    {
        ...
        internal static void Draw()
        {
            try
            {
                ImGui.TextWrapped($"Crafting lists are a fantastic way to queue up different crafts and have them craft one-by-one. Click the '+' icon to create a new list and give it a name." +
